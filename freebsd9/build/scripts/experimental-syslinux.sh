...
# Populate microfs
perl $MW_BUILDPATH/freebsd9/build/minibsd/mkmini.pl $MW_BUILDPATH/freebsd9/build/minibsd/micro.files /  $MW_BUILDPATH/microfs
perl $MW_BUILDPATH/freebsd9/build/minibsd/mklibs.pl $MW_BUILDPATH/microfs > /tmp/m0n0wallmicro.libs
perl $MW_BUILDPATH/freebsd9/build/minibsd/mkmini.pl /tmp/m0n0wallmicro.libs / $MW_BUILDPATH/microfs

cp  $MW_BUILDPATH/freebsd9/build/files/rc.microfs $MW_BUILDPATH/microfs/etc/rc
cp $MW_BUILDPATH/freebsd9/build/files/ttys.microfs $MW_BUILDPATH/microfs/etc/ttys
